    ...
    <div ref={ref} className="sticky top-0 h-[100svh]">
      ...
      >
        ...
        >
          ...
          {/* pt generoso: a carta fixa em top-0, então o topo dela fica sob o
              cabeçalho sticky, e sem essa folga a linha de índice e ano
              desapareceria atrás da barra. */}
          <div className="gutter absolute inset-0 flex flex-col justify-between pb-10 pt-24 text-white sm:pb-14">
            ...
            <div>
              ...
              <p className="type-mono mt-6 text-white/70">
                {caseStudy.tags[locale].join(" • ")}
              </p>
              <span className="type-mono mt-4 inline-block text-white underline-offset-4 opacity-0 transition-opacity duration-300 group-hover:opacity-100 group-hover:underline">
