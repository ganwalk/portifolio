...
async function toLoopMp4(outFile) {
  ...
  // Mesmo patamar já usado em capture-intranet-cover.mjs (perto de
  // lossless de verdade pro libx264, ver o comentário lá pro raciocínio
  // completo por trás desse valor).
